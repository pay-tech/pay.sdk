...
public final class ContextManager {
  ...
  public static Context appContext() {
    if (sAppContext == null) {
      throw new IllegalStateException(
          "ContextManager::appContext needs to be called before ContextManager::init");
    }
    return sAppContext;
  }
  ...
  public static void update(@Nullable Activity activity) {
    sActivity = activity;
  }
  ...
  public static ViewConfiguration viewConfig() {
    return ViewConfiguration.get(appContext());
  }
