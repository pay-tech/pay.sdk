 ...
 * works.
 *
 * Instead, {@link java.util.concurrent.Executors#newCachedThreadPool()} executes all tasks on a new
 * or cached thread immediately because corePoolSize is 0, SynchronousQueue is a queue with size 0
 * and maxPoolSize is Integer.MAX_VALUE. This is dangerous because it can create an unchecked amount
 * of threads.
 */
/* package */ final class AndroidExecutors {
  ...
  /**
   * Compatibility helper function for {@link ThreadPoolExecutor#allowCoreThreadTimeOut(boolean)}
   *
