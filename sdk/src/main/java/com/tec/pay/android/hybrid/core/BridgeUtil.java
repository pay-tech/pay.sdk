...
public class BridgeUtil {
  ...
  final static String YY_OVERRIDE_SCHEMA = "tec://";
  final static String YY_RETURN_DATA =
      YY_OVERRIDE_SCHEMA + "return/";//格式为   tec://return/{function}/returncontent
  ...
  // 获取到传递信息的body值
  // url = tec://return/_fetchQueue/[{"responseId":"JAVA_CB_2_3957","responseData":"Javascript Says Right back aka!"}]
